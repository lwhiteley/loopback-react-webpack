...
const SCSS_SRC_FOLDER = PATH.resolve(__dirname, ROOT, `${BASE_CONFIG.baseFolder}/scss/`);
...
const SCSS_BUILD_FOLDER = PATH.resolve(__dirname, ROOT, BASE_CONFIG.baseFolder + '/public/css/');
